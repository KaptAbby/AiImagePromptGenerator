...
def load_model():
    ...
    train_images, train_labels = load_mnist(r'C:\Users\ADMIN\Downloads\images', kind='train')
    test_images, test_labels = load_mnist(r'C:\Users\ADMIN\Downloads\images', kind='t10k')
...
DATABASE_URL = "mysql+mysqlconnector://root:BismiLlah@localhost/aiimagegenerator"
